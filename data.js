const seriesData = [
    // --- סדרה 1 ---
    {
        ...
        title: "צייר המערות",
        description: "אובו הוא נער קדמון עם כישרון סודי: הוא הצייר הראשון בהיסטוריה! בין חיות טורפות, אבא קשוח, אמא לחוצה ובריונים מציקים, הוא רק רוצה לשרוד… וגם לזכות בלבה של בוגה. מסתבר שגם לפני 35,000 שנה להיות מתבגר היה עסק לא פשוט בכלל. .",
        // 👇 וודא שיש לך קובץ בשם tsayar.jpg בתיקיית images
        image: "./images/tsaiarmearot.jpg",
        episodes: [
